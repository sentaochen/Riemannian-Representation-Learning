...
class RRL(nn.Module):
    ...
    def __init__(self, basenet, n_class, bottleneck_dim, domain_labels = None, alpha_div=1.0, beta_div=0.0, lambda_div=0.01):
    ...
    def forward(self, source, target=None, source_label=None, target_label=None, source_domain_label = None, target_domain_label=None, test_upper_bound=False, label_filter=False, domain_labels=None):
        ...
        if self.training == True and target is None and source_domain_label is not None:
            ...
            loss = H_Distance(features, labels, domain_label, lamda=self.lambda_div, device=DEVICE)
